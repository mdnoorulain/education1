        ...
        <div className="container">
          <div className="heading py-12 text-center w-2/3 m-auto md:w-full">
            ...
            <span className="text-[14px] mt-2 block">
              {" "}
              At A.F Academy School, our top categories include math, science,
              social studies, Urdu, Sanskrit, general knowledge, English, and
              Hindi. We provide comprehensive courses in each subject, taught by
              expert instructors to ensure thorough understanding and success.
            </span>
          </div>
